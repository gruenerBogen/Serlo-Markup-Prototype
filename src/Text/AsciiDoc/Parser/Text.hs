...
p_text :: Parser String
p_text = skipWhitespace *> p_textMiddle

p_textMiddle :: Parser String
p_textMiddle = many1 p_unspecialChar <++> p_textMiddle
           <|> try (p_endOfBlock *> return "")
           <|> try p_hardLineBreak <++> p_textMiddle
           <|> p_whitespace <++> p_textMiddle
